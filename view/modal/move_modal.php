        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="tipoMovimentacao" id="tipoMovimentacao">
                    <label for="quantidade" class="col-form-label"><span class="text-danger">*</span>Quantidade</label>
                    <input type="text" class="form-control" name="quantidadeMovimentacao" id="quantidade">
                    ...
                    <input type="text" class="form-control" name="descricaoMovimentacao" id="descricao">
                </div>
